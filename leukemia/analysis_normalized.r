...
##
setwd("/n/groups/mitchison/Kenichi/collaboration/Nakanishi_single_cell/Shared_Shimada_harvard/non-normalized")
...
##
png("plot_normalized.png",height=400,width=1200)
par(mfrow=c(1,3))
